...
const FormularioModal = ({ handleToggleModal, sendInfo, user }) => {
  return (
    <aside className="modal">
      <form className="form-general-modal" onSubmit={e => sendInfo(e, user)}>
        ...
        <div className="container-tyc">
          ...
          <p>&nbsp;</p>
          <p>
            El presente Política de Privacidad establece los términos en que el
            Politécnico Colombiano Jaime Isaza Cadavid usa y protege la
          ...
          <p>
            el Politécnico Colombiano Jaime Isaza Cadavid Se reserva el derecho
            de cambiar los términos de la presente Política de Privacidad en
            cualquier momento.
          </p>
        </div>
        <div className="container-accpet">
          <button type="submit" className="button-accpet">
            Acepto Términos y Condiciones
          </button>
        </div>
      </form>
      <button className="button-close" onClick={handleToggleModal}>
        x
      </button>
    </aside>
  );
