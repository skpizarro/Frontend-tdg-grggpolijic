...
export default class ConfiguracionAdmin extends Component {
                 ...
                 render() {
                   ...
                   console.log("admin a enviar a editar", user);
                   return (
                         ...
                         {administradores.map(
                           ({
                             ...
                             <AdminInfo
                               ...
                               clave_usuario={clave_usuario}
                               handleShowEditAdmin={
                                 this.handleShowEditAdmin
                               }
                               handleShowDeleteAdmin={
                                 this.handleShowDeleteAdmin
                               }
                             />
                           )
                         )}
